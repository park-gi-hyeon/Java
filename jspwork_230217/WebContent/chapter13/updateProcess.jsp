...
// 			? 4개를 순서대로 값을 세팅
			...
			pstmt.setString(1, name); //1번에는 name //VARCHAR2타입은 setString 메소드 사용
			pstmt.setInt(2, Integer.parseInt(vclass)); //NUMBER 타입은 setInt 메소드 사용
			pstmt.setString(3, tel); //VARCHAR2타입은 setString 메소드 사용
			pstmt.setString(4, id); //VARCHAR2타입은 setString 메소드 사용
